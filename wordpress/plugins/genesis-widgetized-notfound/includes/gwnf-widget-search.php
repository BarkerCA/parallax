...
class DDW_GWNF_Search_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_options = apply_filters( 'gwnf_filter_search_widget_options', array(
			'classname'   => 'gwnf-search-widget',
			'description' => esc_html__( 'A search form for your site. With a more options than the default one.', 'genesis-widgetized-notfound' ) . ' &ndash; ' . sprintf( esc_html__( 'Provided by the plugin %s.', 'genesis-widgetized-notfound' ), '*' . __( 'Genesis Widgetized Not Found & 404', 'genesis-widgetized-notfound' ) . '*' ),
		) );
	...
	public function form( $instance ) {
		...
		$defaults = apply_filters( 'gwnf_filter_search_widget_defaults', array(
			'hide_title'       => 0,
			'title_url'        => '',
			'title_url_target' => 0,
...
}  // end of main class DDW_GWNF_Search_Widget