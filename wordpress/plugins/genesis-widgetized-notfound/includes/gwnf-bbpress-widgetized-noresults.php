...
}  // end of function ddw_gwnf_bbpress_search_actions
 ...
 *
 * @param string 	$gwnf_bbpress_noresults_widget_title
 * @param string 	$gwnf_bbpress_noresults_widget_description
 */
function ddw_gwnf_bbpress_widgetized_noresults_area() {

	$gwnf_bbpress_noresults_widget_title = apply_filters(
		'gwnf_filter_bbpress_noresults_widget_title',
	...
	register_sidebar( array(
		...
		'name'          => esc_attr__( $gwnf_bbpress_noresults_widget_title ),
...
}  // end of function ddw_gwnf_bbpress_widgetized_noresults_area
...
}  // end of function ddw_gwnf_bbpress_noresults_template_logic
...
}  // end of function ddw_gwnf_bbpress_widgetized_noresults_content